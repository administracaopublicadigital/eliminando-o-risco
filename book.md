...
Apenas uma pequena percentagem dos grandes projetos de software do estado são bem sucedidos. De uma forma geral, os projetos públicos de tecnologias de informação costumam correr mal porque o estado não possui conhecimentos básicos sobre o desenvolvimento de software moderno, e depende de processos de contratação desatualizados. Todos os anos, o estado gasta muito dinheiro em projetos para manter e modernizar os sistemas de informação usados, mas os esforços para modernizar esses sistemas antiquados fracassam a uma taxa alarmante e com grande custo para os contribuintes. 
...
Software funcional é entregue no final de cada fase do contrato, sem exceção - totalmente testado, totalmente documentado, pronto para ser usado. Dessa forma, o valor é entregue constantemente, até que o software seja bom o suficiente para ser usado amplamente. A equipa continua a trabalhar até cumprir todas as metas ou ficar sem dinheiro, o que ocorrer primeiro.

O fornecedor é pago pelo tempo dos seus funcionários, não por um sistema de software. Tudo criado pelo fornecedor - software, documentação, investigação, projetos, _tudo_ - é propriedade do Estado, entregue à entidade adjudicante no final de cada fase do contrato. Mudanças tecnológicas, mudanças nas políticas governamentais, mudanças nas regulamentações, mudanças nas leis e mudanças nas prioridades da liderança - qualquer projeto planeado em grande detalhe no início não será capaz de se adaptar a essas mudanças e correrá um risco significativo de falha, derrapagens de custos e prazos significativas ou "pedidos de alteração" caros.
...
A tomada de posse dos projetos de software pelo Estado requer que as equipas deste se concentrem nos resultados e não nas métricas. Isso significa mudar de algumas das práticas tradicionais da gestão de projetos para uma mentalidade orientada ao produto.

A palavra "produto" pode soar incomum no da administração pública, mas é uma parte importante do jargão tecnológico. "Produto" é uma abreviatura para qualquer coisa que será criada: um site, uma aplicação iOS, uma aplicação web, etc. Embora a palavra faça mais sentido para uma empresa que está a vender um produto tangível, tudo o resto sobre este conceito traduz-se perfeitamente para o Estado.

O dono do produto é a pessoa-chave para qualquer projeto de software e _deve_ ser um funcionário público. Ele trabalha com utilizadores, partes interessadas, tecnólogos e o fornecedor para prever a direção do produto, com o objetivo de entregar valor aos utilizadores finais o mais rapidamente possível. Ele prioriza e define iterativamente o trabalho para a equipa de desenvolvimento, como parte do processo ágil. Ele mede o progresso em relação a indicadores de desempenho ​​claros e comunica com as partes interessadas e a equipa multifuncional que está a construir o produto.
...
Ao combinar o design centrado no utilizador, a agilidade, a propriedade do produto, DevOps e a construção com peças desacopladas, é possível partir um contrato grande e arriscado num punhado de contratos menores. Um contrato deve ser pequeno o suficiente para que a entidade pública não tenha escrúpulos em não continuar a dar mais trabalho a um fornecedor com baixo desempenho, substituindo-o por um novo fornecedor. Nesse caso os restantes fornecedores poderão continuar a trabalhar, e a perda total de velocidade será mínima. Um novo fornecedor não deveria ter dificuldade em substituir o antigo, já que o antigo estava entregando software completo, documentado e testado a cada duas semanas. Outro benefício é que pequenos contratos podem chegar abaixo do valor limite da contratação por ajuste direto da administração pública, o que significa que as organizações e entidades podem rapidamente escrever um convite de propostas, publicá-lo e adjudicar um contrato.

Esta abordagem exigirá coordenação e aceitação dos responsáveis pelas contratações. Estes funcionários geralmente estão acostumados à abordagem tradicional de contratualizar projetos de TI: uma grande aquisição baseada em longos Cadernos de Encargos, solicitando dos fornecedores propostas longas, certificações e qualificações desatualizadas. Geralmente, os fornecedores que usam métodos ágeis e centrados no utilizador não têm ideia do que seja "CMMI" ou "ISO-9000" - tais padrões já não são considerados melhores práticas para a criação de sistemas de software flexíveis e económicos. Esta é uma barreira de entrada para muitos dos fornecedores que poderiam ser contratados pela administração pública mas que não desejam gastar todos os recursos necessários para se qualificar e escrever uma proposta.
...
Nas últimas décadas, as entidades públicas deixaram de usar funcionários internos, contando com fornecedores externos para construir as suas ferramentas de tecnologia digital. As decisões para fazer isso foram baseadas em trocas compensatórias que pareciam opções de menor risco - muitas vezes impulsionadas por uma capacidade limitada no Estado e promessas de ferramentas mais baratas "disponíveis no mercado" oferecidas por adjudicatários.

No entanto, aprendemos com exemplos de vários projetos que, embora o Estado possa facilmente externalizar o trabalho de criação de novos sistemas digitais, ele não pode externalizar o risco de falha. Projetos que correm mal refletem-se também na administração pública, não só em empreiteiros ou fornecedores de software.

O governo é, em última análise, responsável pela sua missão, e por consequência, as entidades públicas precisam de ter controlo e responsabilidade pelos projetos que suportam essa missão. O problema que um convite a propostas de TI visa resolver não é um problema técnico; é um problema relacionado com o cumprimento da missão do governo, e a tecnologia é simplesmente um meio para esse fim.
...
O conhecimento técnico é acessível e abundante, mas saber como administrar um serviço ou entidade públicas é uma habilidade rara e valiosa. A administração pública deve abraçar e assumir a sua responsabilidade e o risco de falha, reconhecendo que os fornecedores de tecnologia são contratados apenas para ajudar e devem poder ser facilmente substituíveis se não tiverem o desempenho esperado.

#### Lista de verificação

- O projeto tem um dono do produto dedicado e autorizado, que é funcionário do departamento / serviço - não é um contratado e não é técnico dos serviços de TI da administração pública ;
...
- Existem técnicos superiores identificados e treinados (não contratados) que servirão como donos de produtos dedicados e com poderes para definir a direção, priorizar e supervisionar o trabalho da equipa de desenvolvimento?
- Há uma cadeia de apoio para esta nova abordagem dentro do departamento e das suas chefias superiores, TI central, serviços jurídicos e de contratação pública, bem como o legislativo? Alguma dessas partes interessadas é capaz de bloquear a adoção desta nova abordagem? Em caso afirmativo, qual é o caminho para escalar os problemas, garantindo o alinhamento e evitando que esses bloqueadores internos coloquem o projeto em risco?
...
- O projeto tem um dono do produto dedicado e autorizado que é um funcionário da instituição - não um contratado e não um funcionário dos serviços de TI do estado - cujo trabalho é priorizar o trabalho para a equipa de desenvolvimento;
- Um técnico superior de contratação do governo abraçou este projeto e está entusiasmado com novas formas de aquisição de software;
- O Caderno de Encargos será exclusivamente sobre a aquisição de serviços de desenvolvimento, não sobre a aquisição de algo tangível;
- O Caderno de Encargos exigirá uma equipa multifuncional de designers, investigadores e programadores;
- O Caderno de Encargos não terá mais de 20 páginas de texto;
- Foi criado e adicionado ao Caderno de Encargos um backlog de pelo menos uma dúzia de histórias de utilizador;
...
- O Caderno de Encargos estabelece requisitos claros sobre a entrega regular de código que funcione, documentação, teste e entrega da propriedade de todos os produtos de trabalho ao estado?
...
Mas, para aquisições importantes de tecnologia especializada crítica, seja extremamente cauteloso com as alegações de que SCG ou SaaS funcionarão "fora da caixa". Os fornecedores costumam lançar seus "SCG personalizáveis" e SaaS como uma solução mágica, prometendo que respeitará os seus requisitos regulamentares e de processo específicos. E pode - mas provavelmente somente após extensas modificações.
...
- O orçamento não obriga ao uso de SCG, SaaS ou software personalizado, mas permite que a entidade proponha uma combinação daqueles conforme achar necessário.
...
Historicamente, o progresso em projetos de desenvolvimento de software era medido comparando o trabalho que foi feito com o cronograma de trabalhos que foi estabelecido no início. Isso é feito produzindo indicadores como cronogramas e listas de tarefas concluídas. Mas isso não funciona - o desenvolvimento ágil de software tem isso como premissa. As equipas de desenvolvimento de software modernas nunca ouviram falar de "CMMI" ou "ISO-9000" e não apresentarão propostas a procedimentos de contratação pública que incluam esses requisitos.

Uma filosofia melhor é _demos, não memorandos._ Em vez de medir o progresso olhando para indicadores feitos para o propósito, olhe para o trabalho real que está sendo feito. Junte-se às revisões que são realizadas no final de cada fase do contrato, onde o trabalho realizado naquele sprint é demonstrado para a equipa do projeto e os utilizadores finais convidados. Experimente o site. Instale a aplicação.

Uma parte importante para garantir que o progresso não seja ilusório é que o contrato inclua um Plano de Vigilância de Garantia de Qualidade (PVGQ) que exige, no final de cada fase do contrato, que todo o trabalho respeite padrões específicos. O PVGQ descreve o método pelo qual a entidade adjudicatária determinará se o trabalho do fornecedor é de qualidade suficiente para ser aceite no final de cada fase, permitindo que o fornecedor execute os mesmos testes para garantir que não haverá surpresas.

O PVGC não exige a produção de nenhum artefato explicitamente com o propósito de monitorizar o trabalho - a maneira de monitorizar o trabalho é _ver se ele realmente funciona._ Esta é uma maneira muito diferente de acompanhar o progresso de um projeto de tecnologia. Ela tem a vantagem adicional de ser um teste funcional mais objetivo, observável do que exigir interpretações subjetivas ou legais sobre se o trabalho satisfaz uma longa lista de requisitos.

#### Lista de verificação

- Um funcionário público autorizado e dedicado servirá como o dono do produto;
- Não haverá requisitos de planeamento ou relatório que vão contra a metodologia ágil (ou seja, não há datas para as tarefas específicas serem concluídas e nenhuma especificação de funcionalidade exata que será exigida - seja no Caderno de Encargos, no programa de procedimento ou legislação);
- Haverá um desenvolvedor de software empregado pelo governo que garantirá a conformidade com o PVGQ no final de cada fase do contrato;
- As pessoas que supervisionam, acima do nível do técnico público dono do produto, estão dispostas a receber principalmente "relatórios" na forma de demonstrações de software em funcionamento, combinados com uma revisão das histórias de utilizadores que foram concluídas e aquelas que permanecem por completar;
- Há uma pessoa identificada dentro da instituição que está preparada para fornecer explicações de progresso para cada nível de chefia, porque, geralmente, indicadores de medição de progresso num projeto ágil não são familiares para pessoas que estão acostumadas a projetos em cascata.
...
Se você não tem o conhecimento de que precisa internamente, precisará contratar alguém que tenha - mesmo que apenas temporariamente. Um programador ou designer com experiência na criação de software moderno, idealmente para a administração pública, é sua melhor aposta. Além disso, considere autorizar um ou mais funcionários a passar parte de seu tempo de formação aprendendo os fundamentos do desenvolvimento ágil de software - existem "bootcamps" para o efeito, incluindo algumas opções online.

O custo de contratar um programador ou aprimorar as habilidades dos seus funcionários atuais é pequeno em comparação aos gastos com tecnologia. E uma vez que um funcionário tenha acompanhado um projeto ágil do início ao fim, ele estará melhor equipado para considerar futuros procedimentos de contratação para software personalizado.
...
Embora o software nunca esteja "pronto" - você precisará sempre de se adaptar às mudanças tecnológicas, políticas, regulamentos, legislação e necessidades do utilizador - chegará um ponto em que você precisará de uma equipa muito menor para continuar esse trabalho. Nessa altura torna-se especialmente importante ter vários funcionários da entidade que entendam totalmente o software e que sejam capazes de mantê-lo.

Para projetos maiores, você precisará de contratar uma equipa de desenvolvimento a termo indefinido, sob a supervisão de um dono de produto da administração pública. Nos projectos em cascata, isso chama-se "Operações e Manutenção", mas sob a metodologia ágil, O&M é simplesmente o processo comum de investigação de utilizadores, design, desenvolvimento de software contínuos, etc.

#### Lista de verificação

- Há um ou mais técnicos de contratação pública com experiência no desenvolvimento de software complexo e personalizado usando metodologias ágeis que ajudará na avaliação de procedimentos de contratação de software personalizado;
- Se não houver técnicos de contratação pública com experiência relevante, a entidade tem um contrato com um fornecedor sem conflito de interesses - um sem outros contratos com o estado e sem vínculos ou parcerias com quaisquer produtos SCG;
- A instituição identificou um funcionário da administração pública específico que fornecerá liderança técnica para o projeto, juntamente com provas de sua experiência no desenvolvimento de software personalizado utilizando metodologias ágeis.

#### Questões-chave

- Quando um fornecedor entrega o código no final de cada fase de contrato, que funcionário _específico_ da entidade adjudicante inspeciona o código para garantir a qualidade?
- Se um fornecedor apresenta um custo para concluir um projeto de software específico, que técnico gestor de contratos está equipado para saber se esse é um preço adequado? Qual técnico do serviço de contratação pública _específico_ está equipado para saber se esse é um preço adequado?
- Quando o contrato for concluída, quem fará a manutenção do software? A instituição emprega pessoas que sabem como mantê-la? Eles serão incluídos no processo de desenvolvimento para que possam aprender sobre como ele é construído e ajudar a garantir que seja algo que eles sejam capazes de suportar?

### Minimize o custo de mudança

O Estado e administração pública existirão por muito mais tempo do que qualquer software. E isso significa que, um dia, o seu novo e empolgante sistema de informação poderá tornar-se no seu antigo sistema de informação difícil de usar.
...
Mudanças tecnológicas, mudanças nas políticas governamentais, mudanças nos regulamentos, mudanças na legislação, mudanças nos requisitos de comparticipações comunitárias e mudanças nas prioridades da liderança - qualquer projeto que seja planeado em grande detalhe no início não será capaz de se adaptar a essas mudanças e correrá um risco significativo de falha, derrapagens significativas nos custos e prazos ou "pedidos de alteração" caros.
...
- O Estado será o proprietário de todos os produtos do trabalho do fornecedor;
- Se estiver usando componentes SCG, o fornecedor delineará um caminho de saída para um concorrente - tanto contratual quanto tecnológico - com uma maneira económica de exportar todos os dados armazenados.

#### Questões-chave

- Qual é o plano para reduzir o tempo e o custo de futuras atualizações do sistema devido a mudanças tecnológicas, legislativas, políticas ou fornecedor?
- Quanto custará mudar o sistema para refletir a tecnologia necessária ou as mudanças de políticas?
...
O valor não deve vir no final de um projeto - deve ser fornecido aos utilizadores finais no prazo máximo de seis meses após a adjudicação do contrato, e constantemente a partir daí. No final do _primeiro_ sprint, o código funcional deve ser entregue à entidade adjudicante para sua revisão, e isso deve repetir-se com cada fase contratual subsequente. Os utilizadores finais devem avaliar o trabalho no final de cada fase, independentemente de o trabalho já ter sido implementado para uso diário.
...
- O fornecedor será obrigado a colocar software funcional num ambiente da propriedade do Estado no final de cada fase contratual;
...
- O Caderno de Encargos não fará menção a um cronograma detalhado do projeto, e não haverá menção a cronogramas ou contratos de validação e verificação independentes;
- Um membro da equipa da entidade adjudicante será designado para fornecer supervisão do projeto e coordenará com a liderança do projeto para monitorizar o progresso, comparecendo periodicamente às revisões de cada fase contratual;

#### Questões-chave

- O entidade pública pode providenciar valor aos utilizadores finais em seis meses? Qual é, especificamente, esse valor?
- O entidade pública está preparada para o fornecedor entrevistar e testar continuamente o seu trabalho com utilizadores finais reais - talvez incluindo funcionários da agência?

### Limitar gastos totais

Quanto maior a quantia de dinheiro gasta num projeto de software, maiores as probabilidades de falha.

#### Lista de controle

- A entidade pública entende que não está a receber uma pequena percentagem dos recursos de que acredita precisar - em vez disso, está a receber um processo inteiramente novo para adquirir software, bem como financiamento adequado sob esse modelo.

### Limitar tamanhos de contrato

Usar um único fornecedor por um longo período de tempo ou para um grande número de equipas pode ser mais confortável, mas inevitavelmente leva ao aprisionamento ao fornecedor. Dividir grandes projetos em vários pequenos contratos incentiva os fornecedores a construir um ecossistema de software sustentável, em vez de um monólito, e torna cada contrato pequeno o suficiente para que as probabilidades de sucesso aumentem significativamente.

Deverá exigir que não sejam gastos mais do que um valor máximo num único contrato anualmente, e que nenhum contrato dure mais do que um ou dois anos, incluindo períodos de opção. Dessa forma, você não terá mais do que duas equipas de desenvolvimento de um único fornecedor. Se o projeto precisar de mais equipas de desenvolvimento, obtenha-as de outro fornecedor e faça com que trabalhem separadamente. Limite o Caderno de Encargos também, mantendo-a abaixo de 20 páginas; não gaste mais do que 60 dias a escrevê-lo.
...
- Quando possível, os contratos serão dimensionados dentro do limite do ajuste direto para que possam ser concedidos de forma rápida e fácil;
...
- Os responsáveis pelo procedimento de contratação relevantes leram este manual?
- Os técnicos de contratação pública entendem que não estão a ser solicitado a fazer todo um Caderno de Encargos que vai para um contrato gigante? Eles entendem que contratos mais pequenos são muito mais fáceis de adjudicar e que, com as metodologias ágeis, eles também serão muito mais fáceis de gerir?
...
- O Caderno de Encargos especificará o uso de arquitetura orientada a serviços para cada componente.
...
Embora a equipa de compras fique tentada a procurar fornecedores que já construíram um sistema quase idêntico, isso é desnecessário e limita o conjunto de fornecedores a apenas algumas grandes empresas. Em vez disso, eles devem ampliar seu âmbito e procurar fornecedores que tenham construido algo análogo. Um fornecedor que criou um site para reservar carros de aluguer pode criar um site para solicitar licenças de acampamento em áreas remotas. Um desenvolvedor líder que construiu uma base-de-dados para rastrear as posições dos cometas pode construir uma base-de-dados para rastrear veículos. Ao procurar conhecimento relevante desta forma, a equipa de compras certamente encontrará muitos fornecedores que podem fazer o trabalho.

#### Lista de controle

- O Caderno de Encargos será simplificado (não mais do que 20 páginas) e compreensível por desenvolvedores de software que normalmente não trabalham com a administração pública;
- O programa de procedimento inclui chegar a pequenos fornecedores para incentivá-los a apresentarem propostas;
- O Caderno de Encargos não ficará oculto por detrás de um website de compras que exige registo, mas será publicada abertamente na web para que a comunidade de fornecedores possa partilhá-la;
- O Caderno de Encargos exigirá que os fornecedores identifiquem o seu pessoal-chave nas suas propostas - não mais do que três pessoas - como o programador líder ou o designer líder;
- O programa de procedimento inclui entrevistar os finalistas sobre a abordagem proposta, questionar o pessoal-chave identificado, _não_ a equipa de vendas do fornecedor;
- Os funcionários dos fornecedores não serão obrigados a trabalhar no local numa instalação da entidade pública;
- As equipas de fornecedores e o dono do produto da administração pública terão permissão para usar um serviço de videochamada, uma ferramenta de chat em tempo real e um sistema público de controle de versões baseado em Git e outras ferramentas comumente usadas pelas equipas de desenvolvimento ágil.

#### Questões-chave

- Há algum benefício - político ou outro - em adjudicar contratos a fornecedores locais, ou mesmo requisitos para fazê-lo? Isto pode limitar o grau em que você pode expandir seu grupo de fornecedores?
- Economizar muito dinheiro por cada equipa é razão suficiente para superar quaisquer objeções a ter equipas remotas?
- Foi feita uma investigação de mercado para saber quais fornecedores serão alvos do Caderno de Encargos, em vez de apenas emitir um pedido de informação e esperar que resulte?
...
Se o software for publicado abertamente, os funcionários dos fornecedores ficarão ansiosos para trabalhar nele - torna-se um caso interessante de trabalho que eles podem adicionar ao seu currículo para empregos futuros ou partilhar com amigos, o que ajuda a garantir que você receba os seus melhores esforços. Além disso, os futuros procedimentos de contratação adicionais emitidos para o projeto podem apontar os fornecedores para o código que já foi escrito, permitindo-lhes ver exatamente no que trabalharão ou com o que interagirão. O departamento da administração pública que financia o trabalho pode estar interessado em encontrar maneiras de partilhar o seu software com outras instituições que eles também estejam a financiar.

#### Lista de verificação

- O Caderno de Encargos exigirá que o código-fonte do software seja escrito e mantido em público numa plataforma de codificação social (por exemplo, [GitHub](zhttp://github.com/) ou [GitLab](https://gitlab.com/ )), desde o primeiro dia.
- O Caderno de Encargos exigirá que o software seja explicitamente dedicado ao domínio público ou publicado sob uma [licença de código aberto](https://opensource.org/licenses)
- O Caderno de Encargos usará as melhores práticas de segurança, exigindo que o software seja estritamente separado dos dados e segredos, com testes automatizados para garantir que a separação seja mantida;
- O Caderno de Encargos exigirá que o software seja documentado suficientemente bem para que um desenvolvedor sem conhecimento prévio do projeto possa usá-lo para executar sua própria cópia do software.

#### Questões-chave

- Os responsáveis pela cibersegurança do estado ou da instituição ficarão preocupados com a perspectiva de publicar software de código aberto e assim bloquear a implantação do software?
- Existem outras entidade no estado que possam beneficiar deste software? Eles podem ser consultados antes e durante o processo de desenvolvimento?
- Os serviços jurídicos da entidade pública (ou seu equivalente) farão objeções à publicação de software no domínio público ou sob uma [licença de código aberto aprovada pela OSI](https://opensource.org/licenses)?
...
Para sistemas pequenos, isso pode exigir a adição de um ou menos colaboradores a tempo inteiro à equipa de programadores da entidade. Para sistemas grandes e importantes, isso pode exigir a aquisição de uma equipa para desenvolver e manter o software continuamente.

A manutenção de software às vezes é orçamentada como se fosse uma atividade diferente da construção inicial de software, mas isso é um erro. Manter o software deve significar simplesmente continuar a modificá-lo em resposta às necessidades do utilizador identificadas, que mudam continuamente junto com a legislação, regulamentos, políticas, melhores práticas e tecnologia. Isso requer os mesmos conjuntos de habilidades, metodologia e tarefas como construir um sistema de raíz. Uma proposta para a transição do desenvolvimento de software para uma fase de "operações e manutenção" ("O&M") deve ser vista como um mau sinal.

Em última análise, isso pode fornecer às agências uma fonte previsível de financiamento para projetos de software - substituindo despesas de capital imprevisíveis - ao mesmo tempo que fornece à administração pública um custo anual previsível para todos os projetos de software da agência.

#### Lista de verificação

- A entidade pública reconhece que o software deve ser melhorado continuamente enquanto estiver em uso, porque "manutenção" é funcionalmente o mesmo que construir software desde o início;
- A entidade pública planeia adquirir serviços de desenvolvimento ágil;
- Você conversou com o fornecedor para determinar se ela prefere receber financiamento ao longo dos anos, como um fluxo previsível de financiamento operacional, em vez de um montante fixo;
- Esta abordagem foi coordenada com todos os departamentos e entidades envolvidas - esta é provavelmente uma mudança radical que exigirá confiança e cooperação entre todas as partes;
...
As solicitações de propostas para software personalizado geralmente apresentam pessoas não técnicas fazendo propostas técnicas para outras pessoas não técnicas. Este processo não se presta a fazer perguntas-chave, como muitas das encontradas ao longo deste manual. É importante fazer todas essas perguntas técnicas difíceis e insistir em obter as respostas certas ([consulte o Apêndice A para exemplos de perguntas e respostas](#apêndice-a-perguntas-a-fazer)).

Não é gentileza financiar um projeto que vai fracassar. Se a entidade não sabe exatamente o que quer comprar, não vai conseguir obtê-lo.
...
Quando estiver a considerar um caderno de encargos para um projeto de software personalizado, poderá ser difícil consultar este manual para encontrar as perguntas certas a serem feitas. Aqui estão algumas das perguntas abertas básicas que você pode fazer para determinar se um projeto está configurado para o sucesso.
...
Resposta certa: a entidade pública determinou necessidades específicas com base em entrevistas com utilizadores finais e pode citar várias dessas necessidades especificamente.
...
### O Caderno de Encargos incluirá requisitos de como o sistema irá operar? Em caso afirmativo, quantos requisitos estão incluídos?

Resposta errada: "Passamos o ano passado revendo os nossos requisitos de negócios e escrevemos centenas de requisitos para incluir no Caderno de Encargos, para garantir que obteremos exatamente o que precisamos."
...
### Quanto tempo você espera que o Caderno de Encargos demore?
...
Resposta certa: "Menos de 20 páginas, e esperamos manter isso abaixo do limite de ajuste direto da contratação pública, para tornar mais fácil, mais barato e rápido para novos fornecedores licitarem no projeto."
...
Resposta errada: "Cascata (Waterfall)" ou qualquer resposta que indique falta de compreensão.

Resposta certa: "Agile", "Extreme Programming" (XP) ou "Scrum" são respostas aceitáveis.

### Na equipa que preparou este procedimento de contratação, quem tem experiência no desenvolvimento de software?
...
Resposta certa: "No final de cada fase contratual."
...
### Como você saberá se o projeto está no caminho certo e se os fornecedores estão cumprindo o prometido?
